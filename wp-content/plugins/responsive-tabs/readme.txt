...
= Usage =
Go to [the plugin's documentation](https://wpdarko.com/support/docs/get-started-with-the-responsive-tabs-plugin/) if you need more information on how to use this plugin.

= Support =
Find help in [our support plaftorm](https://wpdarko.com/support) for this plugin (we’ll answer you fast, promise).
...
= Usage =
Go to [the plugin's documentation](https://wpdarko.com/support/docs/get-started-with-the-responsive-tabs-plugin/) for information on how to use it.
...
= Support =
Find help on [our support plaftorm](https://wpdarko.com/support) for this plugin (we’ll answer you fast, promise).
...
= 4.0.5 =
* Fixed conflict with ACF & TinyMCE
...
= 3.3 =
* Add TinyMCE for content field

= 3.2.1 =
* Fix tab removal issue (working on better solution)

= 3.2 =
* Updated read file
* Add metabox framework as dependency

= 3.1.2 =
* Fix minor CSS bugs

= 3.1.1 =
* Allow iframe in tab content

= 3.1 =
* Plugin is now translation ready
* Add French translation
* Add Spanish translation
* Fix auto-scrolling on tab click
* Fix various PHP errors
* Fix major CSS bug (tab spacing)
* Cleaner edit screen
* Security update
...
* Add docs and support forums links
* Add instructions
* Cleaning code
...
= 1.3.1 =
* Add a unique class to tab’s links for customization (user request)

= 1.3 =
* Add nested shortcode support
...
= 1.2 =
* Fix background problem when add images to the tabs
