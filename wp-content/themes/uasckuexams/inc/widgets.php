	...
	function understrap_widgets_init() {
		register_sidebar(
			array(
				...
				'after_widget'  => '</aside>',
				'before_title'  => '<h5 class="widget-title1">',
				'after_title'   => '</h5>',
			)
		);
		...
		register_sidebar(
			array(
				...
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h4 class="widget-title2 text-center">',
				'after_title'   => '</h4>',
			)
		);
		register_sidebar(
			array(
				'name'          => __( 'Side Sidebar', 'understrap' ),
				'id'            => 'side-sidebar',
				'description'   => __( 'Side sidebar widget area', 'understrap' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h5 class="widget-title3">',
				'after_title'   => '</h5>',
			)
		);
		register_sidebar(
			array(
				'name'          => __( 'Middle Sidebar', 'understrap' ),
				'id'            => 'middle-sidebar',
				'description'   => __( 'middle sidebar widget area', 'understrap' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
